...
public class SysIDUtils {
    ...
    public static void bind(CommandXboxController controller, ButtonConfiguration config, Command quasistaticForward, Command quasistaticReverse, Command dynamicForward, Command dynamicReverse) {
        switch (config){
            case XYAB:
    ...
    public static void bind(CommandXboxController controller, ButtonConfiguration config, Function<SysIdRoutine.Direction, Command> quasistatic, Function<SysIdRoutine.Direction, Command> dynamic) {
        bind(controller, config, quasistatic.apply(SysIdRoutine.Direction.kForward), quasistatic.apply(SysIdRoutine.Direction.kReverse), dynamic.apply(SysIdRoutine.Direction.kForward), dynamic.apply(SysIdRoutine.Direction.kReverse));
    }
