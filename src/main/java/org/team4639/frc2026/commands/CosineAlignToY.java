...
public class CosineAlignToY extends Command {
    ...
    public static LoggedTunableNumber YVelocity = new LoggedTunableNumber("CosineAlign/YVelocity").initDefault(5);
    ...
    public static LoggedTunableNumber HeadingKp = new LoggedTunableNumber("CosineAlign/HeadingKp").initDefault(2);

    /* public static LoggedTunableNumber cosPower =
    new LoggedTunableNumber("CosineAlign/CosinePower").initDefault(25);*/

    public static ProfiledPIDController YController = new ProfiledPIDController(
    ...
    public CosineAlignToY(Drive drive, Pose2d setpoint, double xSpeedMetersPerSecond, double cosinePower) {
        this.drive = drive;
    ...
    public void initialize() {
        ...
        YController.setConstraints(new TrapezoidProfile.Constraints(YVelocity.get(), YAcceleration.get()));
    ...
    public void execute() {
        ...
        double xSpeed = Math.abs(Math.pow(
                        setpoint.getTranslation()
