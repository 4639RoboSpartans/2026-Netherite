...
public class AutoCommands4 {
    ...
    public static final Pose2d LEFT_TRENCH_ALIGN_SETPOINT_TO_ALLIANCE_ZONE = new Pose2d(
            FieldConstants.LinesVertical.hubCenter,
            (FieldConstants.LinesHorizontal.leftTrenchOpenEnd + FieldConstants.LinesHorizontal.leftTrenchOpenStart)
                    / 2.0,
            Rotation2d.k180deg);

    public static final Pose2d LEFT_TRENCH_ALIGN_SETPOINT_TO_NEUTRAL_ZONE = new Pose2d(
            LEFT_TRENCH_ALIGN_SETPOINT_TO_ALLIANCE_ZONE.getX() + 1,
            LEFT_TRENCH_ALIGN_SETPOINT_TO_ALLIANCE_ZONE.getY(),
            Rotation2d.kCW_90deg);

    public static final Pose2d LEFT_BUMP_ALIGN_SETPOINT_45 = new Pose2d(
            FieldConstants.LinesVertical.allianceZone - 2,
            (FieldConstants.LinesHorizontal.leftBumpStart + FieldConstants.LinesHorizontal.leftBumpEnd) / 2.0,
    ...
    public static Command LEFT_SINGLE_SWIPE(
        ...
        return new SequentialCommandGroup(
                new ParallelDeadlineGroup(
                        ...
                        SuperstructureCommands.idle(shooter, hood, turret, spindexer, kicker, state),
                        new SequentialCommandGroup(
                                new ParallelCommandGroup(IntakeCommands.retract(extension), IntakeCommands.stop(intake))
                                        .until(() -> state.getEstimatedPose().getX()
                                                > FieldConstants.LinesVertical.hubCenter + INTAKE_AFTER_MOVING_METERS),
                                new ParallelCommandGroup(
    ...
    public static Command RIGHT_SINGLE_SWIPE(
        ...
        return new SequentialCommandGroup(
                ...
                new ParallelDeadlineGroup(
                        ...
                        SuperstructureCommands.autoSpinupToShoot(shooter, hood, turret, spindexer, kicker, state),
                        new ParallelCommandGroup(IntakeCommands.extend(extension), IntakeCommands.intake(intake))),
                new ParallelCommandGroup(
                        drive.run(drive::stopWithX),
                        SuperstructureCommands.requestScoring(shooter, hood, turret, spindexer, kicker, state),
                        IntakeCommands.agitate(extension, intake)));
    ...
    public static Command RIGHT_FAR_SWIPE(
        ...
        return new SequentialCommandGroup(
                ...
                new ParallelDeadlineGroup(
                        ...
                        new ParallelCommandGroup(IntakeCommands.extend(extension), IntakeCommands.intake(intake))),
                new ParallelDeadlineGroup(
                        drive.defer(() -> DriveCommands.PIDToPose(drive, state, mirror(LEFT_SHOOT_SETPOINT), 0.25)),
                        SuperstructureCommands.autoSpinupToShoot(shooter, hood, turret, spindexer, kicker, state),
                        new ParallelCommandGroup(IntakeCommands.extend(extension), IntakeCommands.intake(intake))),
                new ParallelCommandGroup(
                        drive.run(drive::stopWithX),
        ...
        return new SequentialCommandGroup(
                ...
                new ParallelDeadlineGroup(
                        new CosineAlignToY(drive, LEFT_BUMP_ALIGN_SETPOINT_45, BUMP_SPEED, BUMP_COS_POWER)
                                .until(() ->
                                        state.getEstimatedPose().getX() < FieldConstants.LinesVertical.starting - 0.5),
                        SuperstructureCommands.autoSpinupToShoot(shooter, hood, turret, spindexer, kicker, state),
                        Commands.runOnce(() -> {
                            state.setSendVisionToPrimaryPoseEstimator(true);
                            state.resetPose(state.getSecondaryEstimatedPose());
    ...
    public static Command LEFT_CITRUS_DOUBLE_SWIPE(
        ...
        return new SequentialCommandGroup(
                ...
                new ParallelDeadlineGroup(
                        new CosineAlignToY(drive, LEFT_BUMP_ALIGN_SETPOINT_45, BUMP_SPEED, BUMP_COS_POWER)
                                .until(() ->
                                        state.getEstimatedPose().getX() < FieldConstants.LinesVertical.starting - 1),
                        SuperstructureCommands.autoSpinupToShoot(shooter, hood, turret, spindexer, kicker, state),
                        Commands.runOnce(() -> {
                            state.setSendVisionToPrimaryPoseEstimator(true);
                            state.resetPose(state.getSecondaryEstimatedPose());
                ...
                new ParallelDeadlineGroup(
                        new CosineAlignToY(
                                        ...
                                        TRENCH_COS_POWER)
                                .until(() ->
                                        state.getEstimatedPose().getX() > FieldConstants.LinesVertical.hubCenter + 0.5),
                ...
                new ParallelDeadlineGroup(
                        ...
                        new ParallelCommandGroup(IntakeCommands.extend(extension), IntakeCommands.intake(intake))),
                new ParallelCommandGroup(
                        DriveCommands.joystickDriveAtAngle(drive, () -> 0, () -> 0, () -> Rotation2d.kCCW_90deg),
                        SuperstructureCommands.requestScoring(shooter, hood, turret, spindexer, kicker, state),
                        IntakeCommands.agitate(extension, intake)));
    }
        ...
        return new SequentialCommandGroup(
                new ParallelDeadlineGroup(
                        ...
                        new SequentialCommandGroup(
                                ...
                                new ParallelCommandGroup(
                                        IntakeCommands.extend(extension), IntakeCommands.intake(intake)))),
                new ParallelDeadlineGroup(
                        new CosineAlignToY(drive, mirror(LEFT_BUMP_ALIGN_SETPOINT_45), BUMP_SPEED, BUMP_COS_POWER)
                                .until(() ->
                                        state.getEstimatedPose().getX() < FieldConstants.LinesVertical.starting - 1),
                        SuperstructureCommands.autoSpinupToShoot(shooter, hood, turret, spindexer, kicker, state),
                        Commands.runOnce(() -> {
                ...
                new ParallelDeadlineGroup(
                        new CosineAlignToY(
                                        ...
                                        TRENCH_SPEED,
                                        TRENCH_COS_POWER)
                                .until(() -> state.getEstimatedPose().getX() > FieldConstants.LinesVertical.hubCenter),
                        IntakeCommands.stop(intake),
                        IntakeCommands.retract(extension),
                        SuperstructureCommands.idle(shooter, hood, turret, spindexer, kicker, state)),
                new ParallelCommandGroup(
