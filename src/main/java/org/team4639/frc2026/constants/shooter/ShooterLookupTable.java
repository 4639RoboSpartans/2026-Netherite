 ...
 */
public record ShooterLookupTable(
    InterpolatingDoubleTreeMap scoringDistanceToRPM,
  ...
  public ScoringState calculateShooterStateStationary(
      Pose2d turretPose, Translation2d hubTranslation) {
  ...
  public ScoringState convergeShooterStateSOTFTurret(
    ...
    for (int i = 0; i < maxIterations; i++) {
      ...
      Translation2d robotDisplacedToHubTranslation =
          hubTranslation.minus(robotTranslationAfterDisplacement);
    ...
    Translation2d finalRobotToHubTranslation =
        hubTranslation.minus(turretTranslation.plus(turretDisplacement));
