...
public class PassingLookupTable {
  ...
  private static final InterpolatingDoubleTreeMap passingDistanceToHoodRotations =
      InterpolatingDoubleTreeMap.ofEntries(
          new AbstractMap.SimpleImmutableEntry<>(
              FieldConstants.LinesVertical.allianceZone / 2, 50.0 / 360.0),
          new AbstractMap.SimpleImmutableEntry<>(
              FieldConstants.LinesVertical.oppAllianceZone, 30.0 / 360.0));
