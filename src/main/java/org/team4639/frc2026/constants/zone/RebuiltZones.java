...
public class RebuiltZones {
  public static final Zones.Zone OUR_ALLIANCE_ZONE =
      new Zones.BaseZone(
          0, FieldConstants.LinesVertical.allianceZone, 0, FieldConstants.fieldWidth);
  public static final Zones.Zone NEUTRAL_ZONE =
      new Zones.BaseZone(
          FieldConstants.LinesVertical.allianceZone,
          FieldConstants.LinesVertical.oppAllianceZone,
          0,
          FieldConstants.fieldWidth);
  public static final Zones.Zone NOT_OUR_ALLIANCE_ZONE =
      new Zones.BaseZone(
          FieldConstants.LinesVertical.allianceZone,
