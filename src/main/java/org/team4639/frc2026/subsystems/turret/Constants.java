...
public class Constants {
    ...
    public static final double LEFT_ENCODER_OFFSET = -0.447998;
    public static final double RIGHT_ENCODER_OFFSET = -0.461426;
    ...
    public static final double ROTOR_ROTATION_TOLERANCE = 0.5;
}
