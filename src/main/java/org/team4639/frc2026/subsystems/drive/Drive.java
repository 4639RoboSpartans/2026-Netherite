...
public class Drive extends SubsystemBase {
            ...
            new SysIdRoutine.Mechanism(
                ...
                log -> {
                  log.motor("Drive Motor")
                      ...
                      .angularPosition(
                          Radians.of(modules[0].getInputs().turnAbsolutePosition.getRadians()))
                      .angularVelocity(
                          RadiansPerSecond.of(modules[0].getInputs().turnVelocityRadPerSec));
                },
                this));
  ...
  public Command turnSysIdQuasistatic(SysIdRoutine.Direction direction) {
    return run(() -> runCharacterizationAzimuth(0.0))
        .withTimeout(1.0)
  ...
  public void addVisionMeasurement(
    ...
    RobotState.getInstance()
        .accept(camIndex, visionRobotPoseMeters, timestampSeconds, visionMeasurementStdDevs);
  }
