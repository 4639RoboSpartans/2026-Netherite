...
public class LoadShooterLookupTableData {
  public static void loadData(
      InterpolatingDoubleTreeMap distToRPM,
      InterpolatingDoubleTreeMap distToAngle,
      InterpolatingDoubleTreeMap distToTOF) {
    String line = "";
    String splitBy = ",";
    try (BufferedReader br =
        new BufferedReader(
            new FileReader("src/test/resources/frc/robot/constants/shooterTestData.csv"))) {
